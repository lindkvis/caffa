...
public:
    ...
    {
        if ( type == caffa::Session::Type::INVALID || type == caffa::Session::Type::DENIED ) return false;
    ...
    {
        if ( type == caffa::Session::Type::INVALID || type == caffa::Session::Type::DENIED )
            throw std::runtime_error( "Cannot create sessions of type 'INVALID' or 'DENIED'" );
