...
void caf::FieldUiCap<FieldType>::setValueFromUiEditor( const QVariant& uiValue )
{
    ...
    if ( m_optionEntryCache.size() )
    {
        ...
        if ( uiValue.type() == QVariant::UInt )
        {
            ...
            UiFieldSpecialization<typename FieldType::FieldDataType>::setFromVariant( optionVariantValue, fieldValue );
        ...
        else if ( uiValue.type() == QVariant::List )
        {
            ...
            if ( selectedIndexes.isEmpty() )
            {
                ...
                UiFieldSpecialization<typename FieldType::FieldDataType>::setFromVariant( valuesToSetInField, value );
