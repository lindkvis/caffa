...
{
public:
    inline InterfacePointer()
        : m_iface( nullptr )
    {
    }
    inline InterfacePointer( T* iface ) { *this = iface; }
    inline InterfacePointer( const InterfacePointer<T>& other ) { *this = other.p(); }
    ...
    InterfacePointer<T>& operator=( T* iface )
    {
    ...
    InterfacePointer<T>& operator=( const InterfacePointer<T>& other ) { return *this = other.p(); }
