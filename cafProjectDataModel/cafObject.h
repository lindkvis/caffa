...
public:
    ...
    /// type.
    void firstAncestorOrThisFromClassKeyword( const QString& classKeyword, Object*& ancestor ) const;
    ...
    void descendantsIncludingThisFromClassKeyword( const QString& classKeyword, std::vector<Object*>& descendants ) const;

    /// Gets all children matching class keyword. Not recursive.
    void childrenFromClassKeyword( const QString& classKeyword, std::vector<Object*>& children ) const;
};
