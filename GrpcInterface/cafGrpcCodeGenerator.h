...
namespace rpc
{
    ...
    public:
        ...
        virtual std::string generate( const caffa::ObjectHandle* object, bool objectMethodResultOrParameter = false ) = 0;
        virtual std::string generate( const caffa::FieldHandle* field, std::vector<std::string>& dependencies )   = 0;
