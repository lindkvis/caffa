...
{
public:
    Client( const std::string& hostname, int port = 50000 );
    virtual ~Client();
    ...
    std::pair<bool, std::unique_ptr<caffa::ObjectHandle>> execute( gsl::not_null<const caffa::ObjectMethod*> method ) const;
