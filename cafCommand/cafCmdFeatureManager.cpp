...
//--------------------------------------------------------------------------------------------------
std::shared_ptr<ActionWrapper> CmdFeatureManager::action(const QString& commandId)
{
    std::pair<CmdFeature*, size_t> featurePair = createFeature(commandId.toStdString());

    std::shared_ptr<ActionWrapper> act = featurePair.first->action();
...
/// The action is owned by the PdmCommandItemManager
//--------------------------------------------------------------------------------------------------
std::shared_ptr<ActionWrapper> CmdFeatureManager::action(const QString& commandId, const QString& customActionText)
{
    std::pair<CmdFeature*, size_t> featurePair = createFeature(commandId.toStdString());

    std::shared_ptr<ActionWrapper> act = featurePair.first->actionWithCustomText(customActionText);
    m_actionToFeatureIdxMap[act] = featurePair.second;
...
/// The action is owned by the PdmCommandItemManager
//--------------------------------------------------------------------------------------------------
std::shared_ptr<ActionWrapper> CmdFeatureManager::actionWithUserData(const QString& commandId, const QString& customActionText, const QVariant& userData)
{
    std::pair<CmdFeature*, size_t> featurePair = createFeature(commandId.toStdString());

    std::shared_ptr<ActionWrapper> act = featurePair.first->actionWithUserData(customActionText, userData);
    m_actionToFeatureIdxMap[act] = featurePair.second;
