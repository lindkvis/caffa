...
///
//--------------------------------------------------------------------------------------------------
UniqueIdValidator::UniqueIdValidator( const std::set<int>& usedIds,
...
///
//--------------------------------------------------------------------------------------------------
QValidator::State UniqueIdValidator::validate( QString& currentString, int& ) const
{
...
///
//--------------------------------------------------------------------------------------------------
void UniqueIdValidator::fixup( QString& editorText ) const
{
...
///
//--------------------------------------------------------------------------------------------------
int UniqueIdValidator::computeNextValidId()
{
    if ( !m_usedIds.empty() )
    {
