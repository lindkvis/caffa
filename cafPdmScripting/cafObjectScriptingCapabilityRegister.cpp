...
std::map<QString, QString> ObjectScriptingCapabilityRegister::s_classKeywordToScriptClassName;
std::map<QString, QString> ObjectScriptingCapabilityRegister::s_scriptClassNameToClassKeyword;
std::map<QString, QString> ObjectScriptingCapabilityRegister::s_scriptClassComments;

//--------------------------------------------------------------------------------------------------
///
//--------------------------------------------------------------------------------------------------
void ObjectScriptingCapabilityRegister::registerScriptClassNameAndComment( const QString& classKeyword,
...
///
//--------------------------------------------------------------------------------------------------
QString ObjectScriptingCapabilityRegister::scriptClassNameFromClassKeyword( const QString& classKeyword )
{
...
///
//--------------------------------------------------------------------------------------------------
QString ObjectScriptingCapabilityRegister::classKeywordFromScriptClassName( const QString& scriptClassName )
{
...
///
//--------------------------------------------------------------------------------------------------
QString ObjectScriptingCapabilityRegister::scriptClassComment( const QString& classKeyword )
{
