...
template <>
struct FieldScriptingCapabilityIOHandler<QString>
{
...
struct FieldScriptingCapabilityIOHandler<DataType*>
{
                              ...
                              PdmScriptIOMessages*          errorMessageContainer )
    {
        ...
        FieldScriptingCapabilityIOHandler<QString>::writeToField( fieldString,
                                                                     inputStream,
                                                                     errorMessageContainer,
                                                                     stringsAreQuoted );
...
class FieldScriptingCapability : public PdmAbstractFieldScriptingCapability
{
public:
    FieldScriptingCapability( FieldType* field, const QString& fieldName, bool giveOwnership )
