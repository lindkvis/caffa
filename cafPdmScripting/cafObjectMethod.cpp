...
//--------------------------------------------------------------------------------------------------
std::shared_ptr<ObjectMethod> ObjectMethodFactory::createMethod( ObjectHandle* self, const QString& methodName )
{
...
//--------------------------------------------------------------------------------------------------
std::vector<QString> caf::ObjectMethodFactory::registeredMethodNames( const QString& className ) const
{
