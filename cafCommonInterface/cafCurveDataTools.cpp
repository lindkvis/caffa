...
//
//  Caffa is free software: you can redistribute it and/or modify
//  it under the terms of the GNU General Public License as published by
//  the Free Software Foundation, either version 3 of the License, or
//  (at your option) any later version.
//
//  Caffa is distributed in the hope that it will be useful, but WITHOUT ANY
...
///
//--------------------------------------------------------------------------------------------------
CurveDataTools::CurveIntervals CurveDataTools::calculateIntervalsOfValidValues( const std::vector<double>& values,
                                                                                bool includePositiveValuesOnly )
{
    ...
    {
        bool isValid = CurveDataTools::isValidValue( values[vIdx], includePositiveValuesOnly );
...
///
//--------------------------------------------------------------------------------------------------
std::vector<std::pair<size_t, size_t>> CurveDataTools::computePolyLineStartStopIndices( const CurveIntervals& intervals )
{
...
///
//--------------------------------------------------------------------------------------------------
bool CurveDataTools::isValidValue( double value, bool allowPositiveValuesOnly )
{
