...
public:
     ...
     */
    virtual void readFromJson( const nlohmann::ordered_json& jsonFieldObject, const Serializer& serializer ) = 0;
     ...
     * @param serializer the serializer object
     */
    virtual void writeToJson( nlohmann::ordered_json& jsonFieldObject, const Serializer& serializer ) const = 0;
...
public:
    ...
    void readFromJson( const nlohmann::ordered_json& jsonFieldObject, const caffa::Serializer& serializer ) override
    {
    ...
    void writeToJson( nlohmann::ordered_json& jsonFieldObject, const caffa::Serializer& serializer ) const override
    {
